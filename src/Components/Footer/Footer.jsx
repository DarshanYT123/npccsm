  ...
  return (
    <div>
      ...
      <div className="py-2 bg-[#B42120] md:px-28 lg:pb-4 px-4 md:pb-16 pb-3 flex   justify-between ">
        ...
        <div className=" flex flex-row gap-x-4 justify-end lg:gap-x-6">
          <h2 className=" text-[#fff]  text-center text-[7px] lg:text-[15px] md:text-[12px] not-italic font-semibold leading-[157.833%] font-Poppins  ">
            Privacy Policy
          </h2>
          <h2 className=" text-[#fff]  text-center text-[7px] lg:text-[15px] md:text-[12px] not-italic font-semibold leading-[157.833%] font-Poppins ">
            Terms & Conditions
...
{
  /* <a href="tel:942-898-9806" aria-label="Number">+91 94289 89806</a> */
}
